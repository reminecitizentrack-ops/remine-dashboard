  ...
  useEffect(() => {
    ...
    dashboardAPI.getUsers?.()
      .then(res => {
        ...
        setAgents(users.filter(u => ['admin', 'moderator'].includes(u.role)));
      })
      .catch(() => setAgents([]))
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-4 gap-4">
          ...
          <div className="flex items-center gap-2">
            <button onClick={() => loadReports(filters)} disabled={loading}
                    className="bg-gray-100 text-gray-700 px-3 py-2 rounded-lg hover:bg-gray-200 disabled:opacity-50 transition-colors text-sm flex items-center gap-1.5">
